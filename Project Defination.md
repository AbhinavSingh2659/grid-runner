...
→ Deep Q-Network agent (after Q-Learning is understood)
→ Training loop that runs thousands of episodes
→ Visualization mode showing the trained agent playing
...
A performance graph showing improvement over training
You understand RL well enough to rebuild it from scratch
